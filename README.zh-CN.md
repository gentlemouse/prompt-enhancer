...
按下 `Cmd+Shift+E`（或点击按钮），Prompt Enhancer 将你的输入送入 3 阶段处理流水线：
...
- **自带 Key 模式** — 接入 OpenAI / Anthropic / DeepSeek / 自定义 API，无限使用
